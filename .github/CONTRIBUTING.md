...
Additionally, make sure any new code is properly accompanied by working through the following checklist:
  ...
  - [ ] If suitable, funtionality is documented in ``quimb/docs`` or an example notebook added in ``quimb/docs/examples``
  - [ ] The code is linted with PEP8

Extra developer details can be found [here](http://quimb.readthedocs.io/en/latest/develop.html).
