...
- [`tensor_split`](quimb.tensor.tensor_core.tensor_split): add many new decomposition methods — `"qr:svd"`, `"qr:eig"`, `"qr:rand"`, `"lq:svd"`, `"lq:eig"`, `"lq:rand"`, `"rfactor"`, `"rfactor:svd"`, `"rfactor:eig"`, `"rfactor:rand"`, `"lfactor"`, `"lfactor:svd"`, `"lfactor:eig"`, `"lfactor:rand"`, `"rorthog"`, `"rorthog:svd"`, `"rorthog:eig"`, `"rorthog:rand"`, `"lorthog"`, `"lorthog:svd"`, `"lorthog:eig"`, `"lorthog:rand"`, and `"svd:rand"`. The `:svd` and `:eig` submethods allow dynamic truncation; the `:rand` submethods use randomized projection with static truncation via [`svd_rand_truncated`](quimb.tensor.decomp.svd_rand_truncated).
