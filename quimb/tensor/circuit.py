...
def fsimg_param_gen(params):
    theta, Zeta, chi, gamma, phi = params[0], params[1], params[2], params[3], params[4]
...
def apply_fsimg(psi, theta, Zeta, chi, gamma, phi, i, j, parametrize=False, **gate_opts):
...
TWO_QUBIT_PARAM_GATES = {'CU3', 'CU2', 'CU1', 'FS', 'FSIM', 'FSIMG', 'RZZ', 'SU4'}
...
class Circuit:
    ...
    def fsimg(self, theta, Zeta, chi, gamma, phi, i, j, gate_round=None, parametrize=False):
